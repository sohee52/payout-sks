...
## 4. Cash 모듈 리팩토링 - Facade에 직접 구현된 기능들을 UseCase로 분리

* [CashFacade](src\04_Cash_UseCase\CashFacade.java) : 구현로직 없이 유즈케이스 호출로 구성

* UseCase : 비즈니스 로직 구현
  * [CashCreateWalletUseCase](src\04_Cash_UseCase\CashCreateWalletUseCase.java) : 지갑 생성 유즈케이스
  * [CashSyncMemberUseCase](src\04_Cash_UseCase\CashSyncMemberUseCase.java) : 멤버 동기화 유즈케이스  

* [CashSupport](src\04_Cash_UseCase\usecase\CashSupport.java) : UseCase에서 중복되는 코드인 findBy 메서드 모음